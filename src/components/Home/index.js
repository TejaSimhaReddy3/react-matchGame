...
class Home extends Component {
  ...
  onClickImageItem = imageId => {
    this.setState({activeImageId: imageId}, this.check)
  }
    ...
    return (
      <div className="bg">
        ...
        <ul className="img-container">
          {filteredImages.map(eachImages => (
            <ImageItem
              key={eachImages.id}
              imageDetails={eachImages}
    ...
    return (
      <div className="score-card-bg">
        ...
        <div className="score-card">
          ...
          <button className="btn" type="button" onClick={this.onClickPlayAgain}>
  ...
  render() {
    ...
    return <>{endGame ? this.renderScore() : this.renderHome()}</>
  }
}
